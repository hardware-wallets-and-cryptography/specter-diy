...
See [`quickstart.md`](./quickstart.md) for the full procedure. If you don't want
to trust the release keys, you can build the bootloader with **your own public keys**
and sign upgrades yourself — the signing message is a standard Bitcoin signed message,
so most hardware wallets can do it ([`doc/selfsigned.md`](https://github.com/cryptoadvance/specter-bootloader/blob/master/doc/selfsigned.md)).
