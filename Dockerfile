...
# DO NOT REMOVE `--platform=linux/amd64`. It ensures compatibility
# on ARM hosts (e.g., Apple Silicon) since the base image and toolchain
# are amd64-only.
FROM --platform=linux/amd64 python:3.9.15@sha256:b5f024fa682187ef9305a2b5d2c4bb583bef83356259669fc80273bb2222f5ed
ENV LANG=C.UTF-8
